...
import com.portfolio.ymo.Dto.dtoExperiencia;
import com.portfolio.ymo.Entity.Experiencia;
import com.portfolio.ymo.Security.Controller.Mensaje;
import com.portfolio.ymo.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){      
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getImg(), dtoexp.getNombreE(), dtoexp.getDescripcionE());
